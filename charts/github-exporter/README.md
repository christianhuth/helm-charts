...
| image.tag | string | `"v2.3.1"` | Overrides the image tag |
...
| serviceMonitor.scrapeTimeout | string | `""` | Prometheus ServiceMonitor scrapeTimeout, cannot be longer than the scrape interval |
