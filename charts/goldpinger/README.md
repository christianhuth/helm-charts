...
| goldpinger.externalTargets.dns.timeout | int | `500ms` | The timeout for a dns check on the provided dns-targets |
...
| goldpinger.externalTargets.http.timeout | int | `500ms` | The timeout for a http check on the provided http-targets |
...
| goldpinger.externalTargets.tcp.timeout | int | `500ms` | The timeout for a tcp check on the provided tcp-targets |
