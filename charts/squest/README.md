...
| celery.beat.image.tag | string | `"2.8.2"` | Overrides the image tag |
...
| celery.worker.image.tag | string | `"2.8.2"` | Overrides the image tag |
...
| squest.image.tag | string | `"2.8.2"` | Overrides the image tag |
...
| squest.nginx.image.tag | string | `"1.29.5-alpine"` | Overrides the image tag |
