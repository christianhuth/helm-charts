...
| kutt.mail.host                             | string | `""`                             | The host of the external SMTP server that Kutt should use to send emails.                                                                                                                                                                                  |
| kutt.mail.password                         | string | `""`                             | The password to authenticate to the smtp host when sending emails.                                                                                                                                                                                         |
| kutt.mail.port                             | string | `""`                             | The port used to connect to the smtp host.                                                                                                                                                                                                                 |
...
| kutt.mail.username                         | string | `""`                             | The username to authenticate to the smtp host when sending emails.                                                                                                                                                                                         |
