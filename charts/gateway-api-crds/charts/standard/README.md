...
|-----|------|---------|-------------|
| crds | object | `{"backendtlspolicies":true,"gatewayclasses":true,"gateways":true,"grpcroutes":true,"httproutes":true,"referencegrants":true}` | Enable/disable individual CRDs. Keys match each CRD's plural name (`spec.names.plural`). |
