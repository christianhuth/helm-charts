...
| [bindy](./charts/bindy)                                                         | [firestoned/bindy](https://ghcr.io/firestoned/bindy)                                                                               | [Bindy is a Kubernetes operator that manages BIND9 DNS infrastructure declaratively.](https://firestoned.github.io/bindy/)                                 |
...
| [gateway-api-crds](./charts/gateway-api-crds)                                   | none                                                                                                                               | [Custom Resoure Definitions (CRDS) for the Gateway API.](https://github.com/kubernetes-sigs/gateway-api)                                                   |
...
| [keycloak-mcp-server](./charts/keycloak-mcp-server)                             | [sshaaf/keycloak-mcp-server](https://quay.io/sshaaf/keycloak-mcp-server)                                                           | [An MCP server for Keycloak](https://github.com/sshaaf/keycloak-mcp-server)                                                                                |
...
| [kubevirt-cloud-controller-manager](./charts/kubevirt-cloud-controller-manager) | [kubevirt/kubevirt-cloud-controller-manager](https://quay.io/kubevirt/kubevirt-cloud-controller-manager)                           | [Kubernetes cloud-provider for KubeVirt](https://github.com/kubevirt/cloud-provider-kubevirt)                                                              |
...
| [mcp-for-argocd](./charts/mcp-for-argocd)                                       | [argoproj-labs/mcp-for-argocd](https://ghcr.io/argoproj-labs/mcp-for-argocd)                                                       | [An implementation of Model Context Protocol (MCP) server for Argo CD.](https://github.com/argoproj-labs/mcp-for-argocd)                                   |
| [netbird-reverse-proxy](./charts/netbird-reverse-proxy)                         | [netbirdio/reverse-proxy](https://hub.docker.com/r/netbirdio/reverse-proxy)                                                        | [Reverse Proxy for NetBird that provides HTTP and HTTPS access to NetBird-managed services.](https://docs.netbird.io/manage/reverse-proxy)                 |
...
| [node-image-cache](./charts/node-image-cache)                                   | [pause](https://registry.k8s.io/pause)                                                                                             | Pre-pulls a fixed list of container images onto every node, so that pods using them start without waiting for an image pull                                |
| [ntp-exporter](./charts/ntp-exporter)                                           | [sapcc/ntp_exporter](https://ghcr.io/sapcc/ntp_exporter)                                                                           | [Prometheus exporter that checks the drift of a node's clock against a given NTP server or servers](https://github.com/sapcc/ntp_exporter)                 |
...
| [timetagger](./charts/timetagger)                                               | [almarklein/timetagger](ghcr.io/almarklein/timetagger)                                                                             | [An open source time-tracker with an interactive user experience and powerful reporting](https://timetagger.app)                                           |
